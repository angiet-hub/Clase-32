...
//y luego muestre un mensaje que diga, por ejemplo, 
//"Aquí tiene su helado de chocolate, dulce de leche y menta granizada".

const gusto1 = prompt("Ingrese el primer gusto de helado");
const gusto2 = prompt("Ingrese el segundo gusto de helado");
const gusto3 = prompt("Ingrese el tercer gusto de helado");
